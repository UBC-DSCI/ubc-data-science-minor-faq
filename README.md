...
> The application opens in April each year and all the information about the appliction will be available at this time. You need to have finished (or be finishing up) any course prerequisites by the time of the application.
